...
import ProfessionalModal from '../modals/ProfessionalFormModal/ProfessionalFormModal';
...
const Professionals: React.FC<{
  ...
  const handleSave = async (professionalData: Partial<Professional>) => {
    ...
    try {
      ...
      console.error(error);
      toast.error(error.message ?? 'âŒ Error inesperado al guardar el profesional');
    } finally {
