...
import './ProfessionalFormModal.scss';
import { Professional } from '../../../interfaces/Professional';
import ProfessionalAvailabilityForm, {
  AvailabilityFormRef,
} from '../../ProfessionalAvailability/ProfessionalAvailability';
...
const ProfessionalFormModal: React.FC<ProfessionalFormModalProps> = ({
  ...
  return (
    <section>
      <div className={`modal-overlay ${form.professionalId ? 'edit-mode' : 'new-mode'}`}>
        <div
          className={`app-modal modal-custom  ${form.professionalId ? 'edit-mode' : 'new-mode'}`}
        >
