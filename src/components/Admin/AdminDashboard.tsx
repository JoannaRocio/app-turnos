...
import HealthInsurancePanel from '../HealthInsurance/HealthInsurance';
      ...
      {activeTab === 'usuarios' && (
        <>
          ...
          <ConfirmModal
            ...
            message={`¿Está seguro/a que deseas eliminar el usuario de "${selectedUser?.username}"?`}
            onConfirm={async () => {
              if (selectedUser) {
          ...
          <ConfirmModal
            ...
            message={`¿Está seguro/a que deseas crear y descargar el backup?`}
            onConfirm={async () => {
              handleSaveBackup();
            }}
            onCancel={() => {
