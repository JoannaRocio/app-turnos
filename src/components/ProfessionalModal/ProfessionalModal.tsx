        ...
        <div className={`modal modal-patient ${professional?.professionalId ? 'edit-mode' : ''}`}>
          ...
          >
            ...
            <input
              ...
              onChange={e => setForm({ ...form, shiftStart: e.target.value + ':00' })}
            ...
            <input
              type="time"
              value={form.shiftEnd}
              onChange={e => setForm({ ...form, shiftEnd: e.target.value + ':00' })}
            ...
            <div className="modal-buttons">
              <button type="submit" disabled={!form.professionalName || !form.professionalDni}>
                Guardar
              </button>
